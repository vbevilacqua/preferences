...
/// <summary>
/// OAuth security requirements filters.
/// </summary>
...
public class SecurityRequirementsOperationFilter : IOperationFilter
{
    ...
    public void Apply(OpenApiOperation operation, OperationFilterContext context)
    {
        ...
        var anonControllerScope = context.MethodInfo.DeclaringType.GetCustomAttributes(true).OfType<AllowAnonymousAttribute>();

        var anonMethodScope = context.MethodInfo.GetCustomAttributes(true).OfType<AllowAnonymousAttribute>();
